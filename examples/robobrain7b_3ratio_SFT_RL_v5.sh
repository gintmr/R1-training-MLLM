...
Version_RL=robobrain7b_3ratio_SFT_RL_v5
...
python3 -m verl.trainer.main \
    ...
    data.rollout_batch_size=63 \
    worker.actor.model.model_path=${MODEL_PATH} \
    worker.rollout.limit_images=10 \
    worker.rollout.stage=${stage} \
    trainer.experiment_name=${Version_RL} \
    trainer.n_gpus_per_node=3 \
    trainer.load_checkpoint_path=/data2/wuxinrui/R1-training-MLLM/checkpoints/robobrain7b_3ratio_SFT_RL_v1/robobrain7b_3ratio_SFT_RL_v5/global_step_2 \

...
#g 使用/data2/wuxinrui/R1-training-MLLM/checkpoints/robobrain7b_3ratio_SFT_RL_v1/robobrain7b_3ratio_SFT_RL_v8/robobrain7b_3ratio_SFT_RL_v8_step_32_reward_0.40601503759398494/models从budget100开始续训
set -x

export PYTHONUNBUFFERED=1
export CUDA_VISIBLE_DEVICES=1,2,3,5
export NCCL_SOCKET_IFNAME=ens13f0np0
export NCCL_IB_DISABLE=1


MODEL_PATH=/data2/wuxinrui/R1-training-MLLM/checkpoints/robobrain7b_3ratio_SFT_RL_v1/robobrain7b_3ratio_SFT_RL_v10/robobrain7b_3ratio_SFT_RL_v10_step_9_reward_0.42105263157894735/models
...
Version_RL=robobrain7b_3ratio_SFT_RL_v11
...
python3 -m verl.trainer.main \
    ...
    trainer.load_checkpoint_path=/data2/wuxinrui/R1-training-MLLM/checkpoints/robobrain7b_3ratio_SFT_RL_v1/robobrain7b_3ratio_SFT_RL_v11/global_step_5 \

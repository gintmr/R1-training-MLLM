...
MODEL_PATH=/data2/wuxinrui/R1-training-MLLM/checkpoints/robobrain7b_3ratio_SFT_RL_v1/robobrain7b_3ratio_SFT_RL_v4/robobrain7b_3ratio_SFT_RL_v4_global_step_66/models  # replace it with your local file path
...
Version_RL=robobrain7b_3ratio_SFT_RL_v4_2
...
python3 -m verl.trainer.main \
    ...
    trainer.load_checkpoint_path=/data2/wuxinrui/R1-training-MLLM/checkpoints/robobrain7b_3ratio_SFT_RL_v1/robobrain7b_3ratio_SFT_RL_v4_2/global_step_35 \

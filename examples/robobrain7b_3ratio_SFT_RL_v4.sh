...
Version_RL=robobrain7b_3ratio_SFT_RL_v4
...
python3 -m verl.trainer.main \
    ...
    trainer.val_data_save_folder=eval_samples/${Version_RL}_${MODEL_NAME}_budget${budget}_stage${stage}_remaining${remaining}_eval \
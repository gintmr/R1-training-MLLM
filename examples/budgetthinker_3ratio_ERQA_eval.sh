...
MODEL_PATH=/data2/wuxinrui/R1-training-MLLM/checkpoints/robobrain7b_3ratio_SFT_RL_v1/robobrain7b_3ratio_SFT_RL_v8/robobrain7b_3ratio_SFT_RL_v8_step_32_reward_0.40601503759398494/models  # replace it with your local file path
...
Version_RL=budgetthinker_3ratio_ERQA_eval
